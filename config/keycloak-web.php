...
/*keyCloakUrl: 'https://auth.lifewatch.eu',
keyCloakRealm: 'lifewatcheric',
keyCloakClientId: ‘lifwatch-greece',
*/
...
return [
     ...
     */
    'base_url' => env('KEYCLOAK_BASE_URL', 'https://auth.lifewatch.eu'),
     ...
     * Default is master
     */
    'realm' => env('KEYCLOAK_REALM', 'lifewatcheric'),
     ...
     */
    'client_id' => env('KEYCLOAK_CLIENT_ID', 'lifwatch-greece'),
